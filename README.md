...
I'm an Economist and Data Analyst with five years of professional experience working with data. My background in economics has given me a strong analytical foundation, while my professional experience has allowed me to develop practical skills in data analysis, reporting, and business intelligence.

I have experience working with SQL, Python, Power BI, Excel, and data transformation tools. I enjoy working with data to identify patterns, uncover insights, and support better decision-making. I'm particularly interested in transforming raw data into clear and actionable information that can help businesses understand their performance and improve their processes.
...
My CV is available [here.](https://github.com/joanfernandez10/Data-Analysis-Portfolio/blob/main/Joan_Tadeo_Fernandez_CV.pdf) (Download raw file button)
...
**Description:** The project focused on analyzing the Olist Brazilian E-Commerce dataset, which contains information on orders, customers, sellers, products, payments, deliveries, and customer reviews. The analysis involved data exploration, data quality checks, and SQL-based analysis of factors potentially associated with customer satisfaction, including delivery time, late deliveries, freight costs, product categories, payment methods, installments, order value, sellers, and geographical distance.

**Skills:** SQL, data exploration, data quality analysis, data aggregation, CTEs, window functions, date and time analysis, data analysis.

**Technology:** SQLite, SQL, DB Browser for SQLite.
